...
@section('content')
@include('layouts.root/page-title', ['subtitle' => 'Admin', 'title' => 'Edit Role'])
    <div class="">
            ...
            <div class="mb-0 page-block card">
                <div class="card-body">
                    ...
                    <div class="">
                        ...
                        <form action="{{ url('roles/'.$role->id)}}" method="POST" class="space-y-4">
                            @csrf
                            @method('PUT')
                            <div>
                                <label for="name" class="inline-block mb-2 text-sm font-medium text-default-800">Role Name</label>
                                <input type="text" id="name" name="name" class="border rounded-md form-input focus:ring focus:ring-blue-100" value="{{ $role->name }}">
                            </div>
                            <div>
                                <button type="submit"
